...
class CircuitsControllerTest < ActionController::TestCase
  ...
  test "should create circuit" do
    assert_difference('Circuit.count') do
      post :create, circuit: { carrier: @circuit.carrier, id: @circuit.id, site_id: @circuit.site_id, speed: @circuit.speed, type: @circuit.type }
    end
  ...
  test "should update circuit" do
    patch :update, id: @circuit, circuit: { carrier: @circuit.carrier, id: @circuit.id, site_id: @circuit.site_id, speed: @circuit.speed, type: @circuit.type }
    assert_redirected_to circuit_path(assigns(:circuit))
  end
